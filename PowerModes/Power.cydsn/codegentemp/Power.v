...
module top ;
	...
	wire [0:0] tmpFB_0__ModeSwitch_net;
	...
	cy_psoc3_pins_v1_10
		...
		ModeSwitch
		 (.oe(tmpOE__ModeSwitch_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ModeSwitch_net[0:0]}),
	...
	cy_psoc3_pins_v1_10
		#(.id("dd80dd14-0a13-452f-a7e7-44588453287f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__RESET_LED_net;
	wire [0:0] tmpFB_0__RESET_LED_net;
	wire [0:0] tmpIO_0__RESET_LED_net;
	wire [0:0] tmpINTERRUPT_0__RESET_LED_net;
	electrical [0:0] tmpSIOVREF__RESET_LED_net;

	cy_psoc3_pins_v1_10
		#(.id("74ee06a2-ceda-40bc-b463-9cef49a6bcc8"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RESET_LED
		 (.oe(tmpOE__RESET_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RESET_LED_net[0:0]}),
		  .io({tmpIO_0__RESET_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__RESET_LED_net),
		  .interrupt({tmpINTERRUPT_0__RESET_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RESET_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
